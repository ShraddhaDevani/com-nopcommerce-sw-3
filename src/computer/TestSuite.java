...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Pari");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Patel");
        sendTextToElement(By.id("BillingNewAddress_Email"), "paripatel@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "Maza");
        ...
        sendTextToElement(By.id("CardCode"), "543");
