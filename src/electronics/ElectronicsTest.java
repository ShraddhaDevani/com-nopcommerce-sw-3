...
//        Assert.assertEquals(expectedquantity, actualquantity);
        ...
        sendTextToElement(By.id("FirstName"), "Pooja");
        sendTextToElement(By.id("LastName"), "Patel");
        sendTextToElement(By.id("Email"), "poojapatel15@gmail.com");
        sendTextToElement(By.id("Password"), "pooja@4567");
        sendTextToElement(By.id("ConfirmPassword"), "pooja@4567");
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Park street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "NW167PW");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "+4478693148693");
        ...
        sendTextToElement(By.id("CardholderName"), "Pooja Patel");
        //card number
